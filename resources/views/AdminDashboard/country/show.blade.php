    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Country') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="card-header pb-0">
                            <div class="row row-xs wd-xl-60p">
                                <div class="col-sm-6 col-md-12">
                                    <a class="btn btn-primary btn-ripple" href="{{ route('country.index') }}">
                                ...
                                <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                    ...
                                    <div class="sizes d-flex mt-5">
                                        ...
                                        <span class="size d-flex" data-toggle="tooltip" title="small">
                                            <label class="mb-0">
                                                <span class="font-weight-bold">{{ $country->ar_name }}</span>
                                            </label>
                                        </span>
                                    </div>
                                    ...
                                    <div class="sizes d-flex mt-5">
                                        ...
                                        <span class="size d-flex" data-toggle="tooltip" title="small">
                                            <label class="mb-0">
                                                <span class="font-weight-bold">{{ $country->en_name }}</span>
                                            </label>
                                        </span>
                                    </div>
