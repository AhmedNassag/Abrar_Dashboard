    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Departments') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
        ...
        <div class="row">
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Departments') }}</h4>
                                    ...
                                    <tbody>
                                        @if($departments->count() > 0)
                                            ...
                                            @foreach ($departments as $item)
                                                    ...
                                                    <td class="text-center notPrint">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu tx-13 bd-primary rounded-5">
                                                                <a class="dropdown-item" href="{{ route('department.show',[$item->id]) }}" title="{{ trans('main.Show') }}">
                                                ...
                                                @include('AdminDashboard.department.editModal')
                                                @include('AdminDashboard.department.deleteModal')
            ...
            @include('AdminDashboard.department.addModal')
            @include('AdminDashboard.department.deleteSelectedModal')
