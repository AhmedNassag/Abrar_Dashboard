...
@section('content')
        ...
        <div class="row">
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Users') }}</h4>
                                ...
                                <table class="table text-md-nowrap dataTable no-footer" id="example1" role="grid" aria-describedby="example1_info">   
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center border-bottom-0">{{ trans('main.age')}}</th>
                                            <th class="text-center border-bottom-0">{{ trans('main.credit')}}</th>
                                            <th class="text-center border-bottom-0">{{ trans('main.status')}}</th>
                                        ...
                                        @if($users->count() > 0)
                                            ...
                                            @foreach ($users as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center notPrint">
                                                        @if($item->img)
                                                            <img src="{{ asset('public/attachments/user/'.$item->img) }}" alt="{{ $item->img }}" height="50" width="50">
                                                            <br>
                                                            <a class="btn btn-outline-success btn-sm" href="{{ url('show_file') }}/user/{{ $item->img }}" role="button"><i class="fas fa-eye"></i></a>
                                                            <a class="btn btn-outline-info btn-sm" href="{{ url('download_file') }}/user/{{ $item->img }}" role="button"><i class="fas fa-download"></i></a>
                                                        @endif
                                                    </td>
                                                    <td class="text-center notPrint">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu tx-13 bd-primary rounded-5">
                                                                <a class="dropdown-item" href="{{ route('user.show',[$item->id]) }}" title="{{ trans('main.Show') }}">
                                                ...
                                                @include('AdminDashboard.user.editModal')
                                                @include('AdminDashboard.user.deleteModal')
            ...
            @include('AdminDashboard.user.addModal')
            @include('AdminDashboard.user.deleteSelectedModal')
